...
<figure class="slide-figure">
  <img src="/slides/advanced/page-071.jpg" alt="API は流出してはいけない">
  <figcaption>API キーが流出すると自分に請求が来る（p.71）</figcaption>
</figure>
...
スライド原文（p.72）の整理に倣って、5 つの鉄則を覚えてください。
...
<figure class="slide-figure">
  <img src="/slides/advanced/page-082.jpg" alt="個人情報を扱うときの注意">
  <figcaption>決済・メール配信などは自作しない（p.82）</figcaption>
</figure>

スライド原文：

> - Supabase で個人情報を扱うときは細心の注意を払う
> - データベースを作るとき Open になっていないか確認
> - **決済・メール配信など重たいサービスは自作しない**
> - EC であれば Shopify や Base などを使う
...
- 「動いた = 安全」ではない
- 公開デプロイ前には **必ず権限設定を確認**
- 「**Supabase セキュリティ対策**」等で検索！（p.83 でも強調されている）
